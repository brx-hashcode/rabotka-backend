...
function makeGuard(superCanActivateResult: boolean = true) {
  ...
  Object.getPrototypeOf(Object.getPrototypeOf(guard)).canActivate = jest.fn().mockReturnValue(superCanActivateResult);
  return guard;
}
...
describe('ProfileAuthGuard', () => {
  ...
  it('returns false when super.canActivate returns false', async () => {
    jest.spyOn(Object.getPrototypeOf(Object.getPrototypeOf(guard)), 'canActivate').mockReturnValue(false);
